...
public class No1_MyFirstWebDriverTest {
    ...
    */
    ...
    @Test
    public void checkSpursWebsiteTitleIsCorrect() {
        ...
        */
        ...
        Assert.assertTrue("The page title is incorrect",
                driver.getTitle().startsWith("Welcome to tottenhamhotspur.com"));
    ...
    @Test
    public void checkBbcFootballWebsiteTitleIsCorrect() {

        WebDriver driver = new HtmlUnitDriver();
        driver.get("http://www.bbc.co.uk/football");

        Assert.assertTrue("BBC football website title is incorrect", driver.getTitle().matches("Football - BBC Sport"));
